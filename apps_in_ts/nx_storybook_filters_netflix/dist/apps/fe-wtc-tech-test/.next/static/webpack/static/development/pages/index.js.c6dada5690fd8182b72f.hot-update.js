...
function Card(_ref) {
  ...
  /*
     useCallback(()={},[depends]) and useMemo(()=>{}(),[depends]) has to work with 
     child Component that is wrapped with React.memo(ChildComponent)
  
     both create momoized element (functions and for React.memo componet)
     based on the factor if any of [depends] changes or any of 
     React.memo [props] changes, both parent and child will re-render
  
     even if the component is function and after re-rending it using the 'same' function
     in javascript world it is not the SAME! because it was re-render again with the same 
...
//# sourceMappingURL=index.js.c6dada5690fd8182b72f.hot-update.js.map